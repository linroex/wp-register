...
恭喜您已成功報名認養368隻限量布卡蛙。<br/>

現在就邀請您加入雲門教室Facebook「當我們動在一起」，最新的活動消息都在這裡!<br/>

<a href="https://www.facebook.com/ilovecgds"><img src="http://puca.cgds.com.tw/wp-content/uploads/logo_facebook2.jpg" alt=""></img></a>
MSG;
            mail($_POST['prefix_email'],'報名成功通知信',$msg,'Content-type: text/html');
            die('建立成功');
...
text;
    ...
    public function safe_download($path)
    {
